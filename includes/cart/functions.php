	...
	if ($cart) :
		foreach ($cart as $key => $item) :
	      ...
	      if(!empty($country)){  $address .= $country; }
				...
				$booking_list_html .= '<a href="https://maps.google.com/?daddr='. $hotelname .'" target="_blank" style="margin:5px 0px;font-family: Helvetica, Arial, sans-serif; background-color: #820053; color: #fff;font-size: 11px; text-decoration: none;border: 10px solid #820053; margin-top:10px;">Driving Directions</a>';
