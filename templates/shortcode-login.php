	...
	<form id="edd_login_form" class="edd_form" action="" method="post">
		<div>
			...
			<p>
				...
				<input name="edd_user_login" id="edd_user_login" class="required edd-input form-control" type="text" title="<?php _e( 'Username', 'easy-digital-downloads' ); ?>"/>
			</p>
			<p>
			...
			<p>
				...
				<a href="<?php echo wp_lostpassword_url(); ?>" title="<?php _e( 'Lost Password', 'easy-digital-downloads' ); ?>" class="forgotpassword">
