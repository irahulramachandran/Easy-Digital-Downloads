...
function bind_confirm_booking()
{
  $("#confirmBooking").click(function(event){
    ...
    $.ajax({
      url: ajaxUrl,
			type: "POST",
			data: confirmBookingParam,
      dataType: 'html',
      success:function(response){
        alert(response);
        window.location.href = "http://localhost:9696/rivasurya/";
      },
